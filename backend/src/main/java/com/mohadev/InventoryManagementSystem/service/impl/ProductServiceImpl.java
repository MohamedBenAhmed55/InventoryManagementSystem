...
import com.mohadev.InventoryManagementSystem.entity.Category;
...
import com.mohadev.InventoryManagementSystem.repository.CategoryRepository;
import com.mohadev.InventoryManagementSystem.repository.ProductsRepository;
import com.mohadev.InventoryManagementSystem.service.ProductService;
...
//    }
    ...
    private String saveImage(MultipartFile imageFile) throws IllegalAccessException {
        if(!imageFile.getContentType().startsWith("image/")){
            throw new IllegalAccessException("Only image files are allowed");
        }
        ...
        try{
            ...
            imageFile.transferTo(destinationFile); // write in the folder
        }catch (Exception e){
